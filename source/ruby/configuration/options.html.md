...
-> **Note**: At this time only the Ruby library supports this feature and the [AppSignal agent](/appsignal/how-appsignal-operates.html), which is used by the Ruby library, does not yet support this.
